...
namespace Assisgnment_06
{
    internal class Program
    {
        static SqlDataReader reader;
        static SqlConnection con = new SqlConnection("Server=DESKTOP-OT2PTPM;Database=ProductInventoryDb;Trusted_Connection=true");
        ...
        {
            cmd = new SqlCommand("Insert Into ProductInventory(ProductId,ProductName,Price,MfDate,ExpDate,Quality) Values (@id,@name,@price,@quantity,@MFD,@ED)", con);
            con.Open();
